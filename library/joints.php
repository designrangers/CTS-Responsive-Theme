...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // adding Foundation scripts components in the footer
...
return '...  <a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'jointstheme') . get_the_title($post->ID).'">'. __('', 'jointstheme') .'</a>';
}
